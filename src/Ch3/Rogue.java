...
import Ch3.BGM.*;
import Ch3.Thread.Pet;
import Ch3.Thread.Pet2;
import Ch3.Thread.Pet3;
            ...
            switch (input) {
                ...
                case 2:
                    ...
                    if (input == 1 && count >= 3) {
                        ...
                        t5.start();
                        s4.run();
                        System.out.println("☞ 부적을 붙인 표창 3개가 몬스터에게 비수로 꽂힙니다");
                        System.out.println("\n");
                        ...
                        s5.run2();
                        s5.run3();
                        System.out.println("☞ 검은 에너지가 모인 풍차수리검을 소환하여 몬스터에게 날립니다");
                        System.out.println("\n");
